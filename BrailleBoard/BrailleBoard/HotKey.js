...
const HotKey = ({ navigation }) => {
    ...
    const data = [
        { key: '1', label: 'Home H + >', imagePath: require('./assets/mark.png') },
        { key: '2', label: 'Cange Lang L + >', imagePath: require('./assets/mark.png') },
        { key: '3', label: 'Tab T + <>', imagePath: require('./assets/mark.png') },
        { key: '4', label: 'Delete D + <', imagePath: require('./assets/mark.png') },
        { key: '5', label: 'Stop Music M + >', imagePath: require('./assets/mark.png') },
        { key: '6', label: 'Talkback T + <', imagePath: require('./assets/mark.png') },
        { key: '7', label: 'Mute M + <', imagePath: require('./assets/mark.png') },
        { key: '8', label: 'Vice G + >', imagePath: require('./assets/mark.png') },
        { key: '9', label: 'Charging C + <>', imagePath: require('./assets/mark.png') },
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigateToScreen('ProfilePage')}>
                <Text style={styles.buttonText}>HotKey</Text>
            </TouchableOpacity>
